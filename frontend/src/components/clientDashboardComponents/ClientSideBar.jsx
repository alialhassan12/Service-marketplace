            ...
            <ul className="menu bg-white h-full min-w-60 p-4 space-y-2 flex flex-col">
                ...
                <div className="flex flex-col flex-1 justify-between">
                    <div className="flex flex-col space-y-1">
                        ...
                        {/* my jobs */}
                        <li><a onClick={()=>setPage("myJobs")} className={active==="myJobs"? "bg-blue-200 text-blue-500" : ""}>
                        <WorkOutlineIcon/>My Jobs
                            </a></li>
                        {/* messages */}
                        ...
                        {/* payments */}
                        <li><a onClick={()=>setPage("payments")} className={active==="payments"? "bg-blue-200 text-blue-500" : ""}>
