                        ...
                        <Box p="4" style={{ borderBottom: '1px solid var(--gray-5)' }}> 
                            <Flex justify="between" align="center" mb="4">
                                ...
                                <Dialog.Root open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                                    <Dialog.Trigger>
                                        <IconButton variant="ghost" color="gray" onClick={() => setIsDialogOpen(true)}>
                                            <Plus size={18} />
                                        </IconButton>
                                    </Dialog.Trigger>
                                    ...
                                    <Dialog.Content style={{ maxWidth: 450 }}>
                                        ...
                                        <Dialog.Description size="2" mb="4">
                                            Search for a client by name to start a new conversation.
                                        </Dialog.Description>
                                        ...
                                        <Flex direction="column" gap="3">
                                            <Flex direction="row" gap="2" align="center">
                                                ...
                                                <Button variant="solid" color="blue" loading={searchClientsLoading} onClick={() => handleSearchNew(searchQueryNew)}>
                                                    Search
                                                </Button>
                                            </Flex>
                                                        ...
                                                        <>
                                                            {searchClientsLoading ? (
                                                                ...
                                                                <Flex direction="column" align="center" justify="center" p="4" style={{ opacity: 0.5 }}>
                                                                    <SearchCheck size={32} />
                                                                    <Text size="2" mt="2">Search for clients to start chatting</Text>
                                                                </Flex>
                                                            )}
                                                        </>
                                                    )}
